...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoAdd = __webpack_require__(23);
	...
	var TodoApp = (function (_Component) {
	    ...
	    _createClass(TodoApp, [{
	        ...
	        value: function create() {
	            ...
	            var btn = (0, _create2.default)('a').txt('btn');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Component = (function () {
	    ...
	    function Component(props) {
	        ...
	        var defaultProps = Object.assign({}, this.constructor.defaultProps);
	    ...
	    _createClass(Component, [{
	         ...
	         *
	         * Called to this function instead of
	        ...
	        key: 'unmountByIndex',
	        value: function unmountByIndex(index) {
	         ...
	         * @returns {Function} - return value of closure
	         */
	
	    }, {
	        key: 'react',
	        value: function react(fn) {
	        ...
	        key: 'mountRoutedComponent',
	        value: function mountRoutedComponent(parent) {
	            var _this = this;
	            ...
	            if ((0, _isFunction2.default)(parent)) {
	                ...
	                throw new Error('Routed Component cannot be assigned. Please make sure parent is an Element or a closure.');
	            }
	        ...
	        key: 'setIsolatedState',
	        value: function setIsolatedState(state) {
	            this.setState(state);
	            this.isolated = true;
	            return this;
	        }
	        ...
	        key: 'on',
	        value: function on(el, type, fn, dFn) {
	            var Component = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 *  Replaces an Element for another one
	 *
	 * @param {Element} parent - parent element to replace child on
	...
	function replace(parent, child) {
	    ...
	    var replacedChild = replaceLastChild ? parent.lastChild : parent.firstChild;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function extension(prefix) {
	    ...
	    Object.defineProperty(ElementPrototype, addPrefix('parentAppend'), { value: function value(child) {
	            ...
	            return this.parentNode.append(child, chain);
	        } });
	     ...
	     */
	    Object.defineProperty(ElementPrototype, addPrefix('replaceWith'), { value: function value(newElement) {
	     ...
	     */
	    Object.defineProperty(ElementPrototype, addPrefix('before'), { value: function value(newSibling) {
	     ...
	     * @returns {Element} - the new Element
	     */
	    Object.defineProperty(ElementPrototype, addPrefix('after'), { value: function value(newSibling) {
	            var parentNode = this.parentNode,
	...
	var TodoList = (function (_Component) {
	    ...
	    _createClass(TodoList, [{
	        ...
	        value: function create() {
	            ...
	            //        // TODO: set as state instead of props create and mount one time
	            //        // TODO: CollectionWrapper to distinguish between mounted Components
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reaction = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Collection = (function (_Component) {
	    ...
	    _createClass(Collection, [{
	        ...
	        key: 'iterate',
	        value: function iterate(arr, obj) {
	        ...
	        // Overwrite update a Collection has no statefulls
	        ...
	        // Does nothing, state is set in constructor
